...
Optimize and generate the calibrated CatBoost-XGBoost-pruned-LightGBM ensemble with:
...
Train the independent XGBoost temporal model with:
...
Train the selected 300-feature log-stress model across five folds with:
