"""Train an independent ten-fold repeat of the strongest Ordered CatBoost."""
...
def main() -> None:
    ...
    metrics_path = (
        ARTIFACT_DIR / "catboost_jointstress_ordered_10fold_repeat_metrics.json"
    )
    ...
    print("Saved submissions/catboost_jointstress_ordered_10fold_repeat_100.csv")
